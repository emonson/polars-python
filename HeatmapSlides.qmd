...
- This ends up being a nice case study for using basic Polars<br>+ visualization with Altair (the default plot module)
...
- **If the IDs were integers we'd force them to be read as a strings <br>to not lose any leading zeros**
:::
...
#| code-line-numbers: 4-6|8-12|14-24
# days_version = "full"
days_version = "abbreviation"
...
- Repo: [https://github.com/emonson/polars-python/]()