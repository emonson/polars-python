---
title: Visualize combined student schedules for each advisor
subtitle: Solving problems with Polars and Altair
format:
    revealjs: 
        slide-number: true
        preview-links: auto
...
![](images/StudentAdvisorSample.png){width="400"}
:::
:::
...
![](images/TimeGridSample.png){width="300"}
:::
::::
...
- Get a separate group for each unique combination of the two
- Unlike Pandas, `.group_by()` returns grouping variables as normal columns
...
## Times to strings for visualization {.smaller}
...
- Finally... :-)
- Grouping and aggregation in Polars so:
    - not too many data rows in Altair
    - faster 
        - Altair has built-in aggregation
        - It's not very fast
        - VegaFusion helps with this
...
- Want VegaFusion for this since over 14,000 rows without filtering
    - [https://vegafusion.io]()
